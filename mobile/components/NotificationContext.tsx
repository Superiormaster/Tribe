...
export const NotificationProvider = ({
  ...
  /**
   * Refresh notification count and notification list.
   */
  ...
  /**
   * Refresh notifications whenever the user
   * becomes available or the network comes online.
   */
  useEffect(() => {
