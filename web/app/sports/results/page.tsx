// src/app/sports/results/page.tsx
...
export default function ResultsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <SportsHeader
        title="Results"
        subtitle="Latest football scores and completed matches"
      />
        ...
        (_, index) => (
          ...
          >
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="h-9 w-14 rounded-xl bg-gray-100 dark:bg-gray-800" />
            ...
            <div className="mt-4 h-3 w-24 rounded bg-gray-100 dark:bg-gray-800" />
          </div>
        )
      )}
    </div>
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white px-5 py-12 text-center dark:border-gray-800 dark:bg-gray-900">
      ...
      <p className="mx-auto mt-2 max-w-md text-sm text-gray-500 dark:text-gray-400">
        We couldn't retrieve the match results
...
function EmptyState() {
  return (
    <div className="rounded-2xl border border-gray-200 bg-white px-5 py-14 text-center dark:border-gray-800 dark:bg-gray-900">
      ...
      <p className="mx-auto mt-2 max-w-md text-sm text-gray-500 dark:text-gray-400">
        There are no completed matches available
...
function groupResultsByCompetition(
  matches: any[]
) {
